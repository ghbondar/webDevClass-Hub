...
Week 3 | In class | For next class  
 ...
 Fri 11/09 | HTML and CSS: Web browsers and display variations, The [CSS Box Model tutorial](https://internetingishard.com/html-and-css/css-box-model/#changing-box-behavior) |  Homework 7: Style the images and content of one of your web pages using the Box Model: See detailed Homework 7 assignment in the Github Issue.
