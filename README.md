...
Welcome to the webDev Class Hub! This is a repository to help introduce and orient Pitt students to the GitHub collaboration environment.
 ...
 ---- | ---- | ----  
Controlling layout with Flexbox: see [tutorial](https://internetingishard.com/html-and-css/flexbox/), with newtFire examples: HTML: Open URL in oXygen: http://newtfire.org; CSS: Open URL in oXygen: http://newtfire.org/nfIndex.css. Hands on work together with HTML and CSS and posting to newtFire. |[Consult Learn CSS Layout](http://learnlayout.com/), [Flexbox Tutorial](https://internetingishard.com/html-and-css/flexbox/), and [w3 Schools CSS Reference](http://www.w3schools.com/css/) as you code. [HTML/CSS Exercise 2](http://dh.newtfire.org/HTMLExercise2.html)
